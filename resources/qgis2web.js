...
map.getView().fit([8568133.326302, 953572.931924, 8578717.476534, 961368.976706], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Aruvikkara webmap</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (381 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Aruvikkara is a panchayat (a local administrative division) in the Thiruvananthapuram district of Kerala, India, known for its significance as a water source for Thiruvananthapuram city, an ancient Durga temple, a tourist spot with a reservoir and garden, and the headquarters for the Wellington Water Distribution project. The area is situated on the banks of the Karamana River.<br />';
            }
